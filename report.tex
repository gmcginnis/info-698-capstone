...
% You need to maintain a Revision History Table like this: (Not this exact table with ONLY the dates changed)
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{l l l} 
                ...
                % 1.0 & First draft complete, submitted for \hyperref[tab_approvals]{signatures} & 09/22/25 \\
                1.0 & First draft complete & 09/22/25 \\
                \texttt{ " } & Submitted for \hyperref[tab_approvals]{signatures} & 09/23/25 \\
                2.0 & Additional \hyperref[fig_map_island]{map}; expanded \secref{sec_lit} with BCI info; rephrased portions of \secref{sec_es}, \secref{sec_deliv}; typo fix & 09/23/25 \\
                \texttt{ " } & Resubmitted for \hyperref[tab_approvals]{signatures} & 09/23/25 \\
                % 2.0 & Expanded catchment information; updated \hyperref[fig_map]{map} & 09/23/25 \\
                \bottomrule
            \end{tabular}
        \end{table}
        % \begin{table}[h!]
...
The primary goal of this project is to create models that can automate quality assurance of temporal runoff data from the Lutz~catchment of Barro~Colorado~Island~(BCI), Republic~of~Panama (Figure~\ref{fig_map_island}).
...
% The Lutz~Weir (Figure~\ref{fig_weir}) is located on the northeast slope of Barro~Colorado~Island, Panama, and has been collecting runoff data since January 1, 1972.
...
Quality issues in the data come about due to environmental factors (such as partial blockages of the outflow channel), sensor failures, and calibration issues, to name a few.
...
Currently, quality assurance is conducted manually using a customized program in Visual~FoxPro to allow for visual inspection and correction of the data.
...
Past attempts at automated quality assurance using traditional stochastic methods have failed.
...
% \begin{figure}[!hbt]
%     \centering
%     \fbox{\includegraphics[width=.54\textwidth]{figures/map_bci_soil.jpg}}
%     % \caption{The locations of the weir and tower in relation to the ten soil moisture sampling sites in the Lutz~catchment on Barro~Colorado~Island, Panama.\autocite{stri2025}}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{l l}
        ...
        iShowcase & 12/05/25 \\
        Documentation/repository cleanup & 12/09/25 \\
...
% This document is based upon and supersedes the preliminary draft Version 0.5. Deviations, (versus clarifications), from the PDR have been clearly noted. For any requirements not listed in this SOW, the PRD requirements shall remain in effect.
This document is based upon and supersedes the ``First Draft'' Version 1.0. Deviations, (versus clarifications), from the PDR have been clearly noted. For any requirements not listed in this SOW, the PRD requirements shall remain in effect.
...
%         % . & Team Member & . & . \\
%         % . & Team Member & . & . \\
%         Gillian McGinnis & Project Manager & \includegraphics[width=0.2\textwidth]{figures/signature.png} & 09/23/25 \\
%         \midrule
...
\begin{figure}[!hbt]
    \centering
    % \includegraphics[width=.65\textwidth]{figures/signatures.png}
    \includegraphics[width=.99\textwidth]{figures/signatures.png}
    % \caption{The locations of the weir and tower in relation to the ten soil moisture sampling sites in the Lutz~catchment on Barro~Colorado~Island, Panama.\autocite{stri2025}}
    % \caption{A fine-scale topographic map of the Lutz~catchment on Barro~Colorado~Island, Panama, showing the locations of the weir, tower, and ten soil moisture sampling sites.\autocite{hydroPC}}
    % \caption{A fine-scale topographic map of the Lutz~catchment showing the locations of the weir, tower, and ten soil moisture sampling sites.\autocite{hydroPC}}
    % \caption{The location of Barro~Colorado~Island in Panama CITE.}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rllr}
        ...
        \midrule
        \secrefboth{sec_es} & Gillian McGinnis & 389 \\
        \secrefboth{sec_lit} & \ditto & 408 \\
        \secrefboth{sec_deliv} & \ditto & 491 \\
