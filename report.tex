...
Although this issue did not remove a significant amount of entries when compared to the resulting totals ($n=11,489$), it was an error that had not been found previously, and thus made a substantive contribution to the \ac{stri} set.
...
Smoothing can improve predictions by preventing standalone points that differ from their neighbors.\footnote{For exmaple, having a sequence of ``True'' interrupted by one ``False'', or vice-versa, both of which are unlikely in the context of obstructions.}
