...
Computational power also proved a challenge, as there were more than 4.15~million total entries in the raw data set.
This expanded further with feature engineering, since each data point had more than one hundred values associated with it.
