...
\begin{figure}[hbt!]
    ...
    \caption{Different time series segmentation techniques.\autocite{chu1995}}
    \label{fig_chu1995}
\end{figure}
...
\begin{figure}[hbt!]
    ...
    \caption{Visual representation of splitting techniques used in the analysis.}
...
\begin{figure}[hbt!]
    ...
    \caption{Time series showing monthly raw \& adjusted runoff and soil moisture values.}
...
\begin{figure}[hbtp!]
    ...
    \caption{Monthly model accuracy (teal) and percentage of data points containing blockages (light green).}
...
\begin{figure}[hbtp!]
    ...
    \caption{Model performance on a small subset of the test data, where red lines are actual instances of an obstruction.}
...
\begin{figure}[hbtp!]
    ...
    % \includegraphics{outputs/figures/preformance_ex.png}
    \caption{Example of consecutive distinct obstruction events.}
    \label{fig_ex_block}
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    % \includegraphics{outputs/figures/preformance_ex.png}
    \caption{Example of two distinct spike events.}
    \label{fig_ex_spike}
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    % \includegraphics{outputs/figures/preformance_ex.png}
    \caption{Example of an long-spanning calibration adjustment.}
    \label{fig_ex_cal}
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    % \includegraphics{outputs/figures/preformance_ex.png}
    \caption{Example of sub-zero runoff measurements.}
    \label{fig_ex_subz}
\end{figure}
...
\begin{figure}[hbtp!]
    ...
    % \includegraphics{outputs/figures/preformance_ex.png}
    \caption{Example of noisy runoff measurements, which have yet to have accurate adjusted values assigned.}
    \label{fig_ex_noise}
\end{figure}
