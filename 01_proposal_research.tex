...
% You need to maintain a Revision History Table like this: (Not this exact table with ONLY the dates changed)
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{l l l} 
                ...
                0.5 & Expanded \secref{sec_time}; added \hyperref[fig_gantt]{Gantt chart} & 09/22/25 \\
                \bottomrule
            \end{tabular}
        \end{table}
        % \begin{table}[h!]
...
Project work will be conducted remotely, with regular advisor check-ins via teleconference meetings.
...
% 
In the field of remote sensing and geospatial analysis, recurrent neural networks---especially long short-term memory---are successful for analyzing multi-temporal data, however scalability is limited and they can be prone to overfitting.\autocite{dritsas2025}
% 
