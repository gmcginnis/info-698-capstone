...
% You need to maintain a Revision History Table like this: (Not this exact table with ONLY the dates changed)
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{l l l} 
                ...
                0.1 & Converted template to \LaTeX, started bibliography and \secref{sec_es} & 09/13/25 \\
...
% Traditional stochastic methods have been applied and failed to match the quality & accuracy of manually-applied quality assurance of temporal run-off data from the Lutz Weir of Barro Colorado Island, Panama. Given the quantity of raw and manually-corrected data—as well as data of influencing factors (such as rainfall and soil moisture measurements)—it is possible that AI/ML algorithms can be developed to successfully conduct automatic QA.
...
An outline of anticipated features is provided in Table~\ref{tab_dol}.
% 
Dr.~Steven~Paton of the Smithsonian~Tropical~Research~Institute will be the primary contact regarding background information of the data, knowledge of exceptional data point ranges (such as extenuating circumstances, e.g., a tree fall damaging equipment), and any hydrological questions that come about.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ll}
        ...
        Gillian McGinnis & Literature review \& research \\
          ...
          & Failure mode classification model \\
          & Failure mode correction models \\
          & Reproducibility documentation \\
          & Course deliverables and presentation preparations \\
          & User interface (\textit{time permitting}) \\
        \bottomrule
    \end{tabular}
...
\section{User/Market Research}\label{sec_market}
...
\subsection*{Existing competitors}
...
Visual~FoxPro is currently the only software used by Dr.~Paton to manipulate the data.
...
\section{Product Features}\label{sec_features}
...
\custsubsection{Detection of Periods Containing a Failure Mode}
...
\custsubsection{Classification of Failure Mode}

% This section was written by (the owner of the subsystem that implements this feature should write this section.)

% Repeat format from Feature 1 as needed. You should have a minimum of 3 key Features, and a maximum of 8.  Most projects will have 4 or 5.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l p{0.5\textwidth}}
        ...
        \midrule
        Calibration & Standard checks that require baseline correction or slight data pivot. \\
        Spike & Short and abrupt changes in level typically caused by equipment issues.\\
        Sub-zero & The stream runs dry, or when the pond is drained for cleaning.\\
        Signal noise & Equipment failure results in impossible variability of reported values.\\
        \midrule
...
\custsubsection{Quality Assurance on Periods of Failure}


\section{Project Timeline \& Gannt Chart}\label{sec_time}
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l l}
        ...
        Individual failure mode QA models & 11/17/25 \\
        Model instructional writeup & 11/24/25 \\
        % Signed proposal & 2/19/2024 \\
        % Poster Demo & 4/23/24 \\
        iShowcase presentation & 12/05/25 \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{l|l|c|l}
        ...
        % . & Team Member & . & . \\
        % . & Team Member & . & . \\
        Gillian McGinnis & Project Manager & . & 09/23/25 \\
        Sriram Iyengar & Advisor & . & . \\
