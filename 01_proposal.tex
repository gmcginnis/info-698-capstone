...
% You need to maintain a Revision History Table like this: (Not this exact table with ONLY the dates changed)
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{l l l} 
                ...
                0.1 & Converted template to \LaTeX, started \hyperref[sec_bib]{References} and \secref{sec_es} & 09/13/25 \\
...
\begin{figure}[hbt!]
    ...
    \caption{The Clearing (``\textit{El~Claro}'') on Barro~Colorado~Island, Panama.~\parencite{stri2025}}
...
\custsubsection{Classification of Failure Mode}\label{subsec_class}
...
Based on the classification result from Feature~\hyperref[subsec_class]{2}, additional models will attempt to adjust the raw outputs to the appropriate values had an error not occurred. This will likely involve creation of multiple separate models, as the method in which the data is corrected differs based on the classification of failure type---for example, an interrupted drainage caused by a blockage in the weir can be fixed by the expected decay curve, while a spike is simply flattened.
...
\begin{table}[htbp]
    ...
    \begin{tabular}{rllr}
        ...
        \midrule
        1. & Executive Summary & Gillian McGinnis & \# \\
        2. & User/Market Research & \ditto & \# \\
        3. & Product Features & \ditto & . \\
        4. & Project Timeline & \ditto & . \\
        5. & Ethics & \ditto & N/A \\
        \bottomrule
    \end{tabular}
    % \caption{Milestone Schedule}
