...
% You need to maintain a Revision History Table like this: (Not this exact table with ONLY the dates changed)
        ...
        \begin{table}[h!]
            ...
            \begin{tabular}{l l l} 
                ...
                1.0 & Started bibliography, Executive Summary & 09/13/25 \\
                \bottomrule
            \end{tabular}
        \end{table}
        % \begin{table}[h!]
...
\begin{figure}[hbt!]
    \centering
    \fbox{\includegraphics[width=.55\textwidth]{figures/map_bci.jpg}}
    \caption{The location of Barro~Colorado~Island in Panama \parencite{stri2025}.}
...
\custsubsection{Temperature Sensing and Logging}
...
\begin{table}[htbp]
    ...
    % \singlespacing
    \centering
    \begin{tabular}{r p{0.6\textwidth} c c}
        \toprule
        \rowcolors{2}{gray!20}{white}
        \# & Question & Generally & Data Brech \\
        \midrule
